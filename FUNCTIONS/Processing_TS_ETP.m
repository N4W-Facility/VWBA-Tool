function Processing_TS_ETP(ProjectPath,DataBasePath)
% -------------------------------------------------------------------------
...
Tmp = matfile(fullfile(DataBasePath,'ETP','ETP.mat'));
% lectura de Longitud
Lon = Tmp.Lon;
% Lectura de latitud
Lat = flip(Tmp.Lat);
...
TS_Path = fullfile(ProjectPath,'02-Biophysic','ETP.csv');
ID_File = fopen(TS_Path,'w');
fprintf(ID_File,'Year,Month,day,Evapotranspiration (mm)\n');
