function [CheckArea,TotalArea,PixelArea] = Porfolio_CR(app, Ap, PorPath)
% -------------------------------------------------------------------------
...
if FinalArea > (app.BasinArea/1E4)
    TotalArea = floor(app.BasinArea*1E4);
end
...
if Ap == 0
    ...
    warndlg(['Spatial distribution of the portfolio was successfully completed. ',...
            'However, the conservation and restaoration area of the analyzed basin only reaches ',...
            num2str(floor(TotalArea*PixelArea/1E4)),' ha. Therefore, consider using',...
